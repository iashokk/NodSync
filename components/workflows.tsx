      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            At NodSync, we’re on a mission to empower dreamers to 
            achieve their academic and career goals with confidence and clarity. NodSync is your friendly
             guide at every step of the journey.
            </p>
          </div>
          {/* Spotlight items */}
