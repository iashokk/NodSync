  ...
  return (
    <footer>
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center justify-center gap-4 py-8 md:flex-row md:justify-between md:py-12" id="giftStopper">
            ...
            <ul className="flex items-center gap-4">
              <li>
                <a
                  ...
                  href="https://github.com/NodSync"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="GitHub"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="h-8 w-8 fill-current">
